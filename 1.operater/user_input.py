'''
code editor-------print()----->consol(output screen)

if there is need to bring user input from output scrren or
...
In above code value are not getting to added,they are joined or
concatenated.
Input given by user in python ia always stored as string by default.

if there is need to convert string to number use following functions.
int():This function use to convert string or integer.
